<main class="bg-form background-grid">
    <div class="d-flex w-100 p-3 min-vh-100 justify-content-center align-items-center">
        <section id="containForm" class="form start-in px-3 py-5">
            <div class="d-flex flex-column text-secondary pb-4">
                <h3 id="stepTitle" class="fw-bold">¡Bienvenido!</h3>
            </div>
                ...
                <div id="step1" class="d-flex flex-column w-100 gap-4 step-1 position-relative active">
                    ...
                    <div>
                        ...
                        <div class="position-relative">
                            <input type="email" class="form-control ps-5 border-0" id="email" name="email" placeholder="Ingresa tu correo" required autocomplete="username">
                    ...
                    <div>
                        ...
                        <div class="position-relative">
                            ...
                            <input type="password" class="form-control ps-5 border-0" id="password" name="password" placeholder="Ingresa tu contraseña" required autocomplete="current-password">
                        </div>
