                ...
                <div id="step1" class="d-flex flex-column w-100 gap-4 step-1 position-relative active">
                    ...
                    <div>
                        ...
                        <div class="position-relative">
                            <input type="email" class="form-control ps-5 border-0" id="email" name="email" placeholder="Ingresa un correo" required autocomplete="off">
                    ...
                    <div>
                        ...
                        <div class="position-relative">
                            ...
                            <input type="password" class="form-control ps-5 border-0" id="password" name="password" placeholder="Ingresa una contraseña" required>
                        </div>
                    </div>
                    <div>
